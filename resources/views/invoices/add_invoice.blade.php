                ...
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="please add invoice number" required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="product" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($products as $product)
                                        <option value="{{ $product->Product_name }},{{$product->section_name}}"> {{ $product->Product_name }}</option>
                                        @endforeach
                                </select>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">invoice value</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">VAT_percent</label>
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>VAT_percent</option>
